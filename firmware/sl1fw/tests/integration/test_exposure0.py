...
from sl1fw.exposure_state import AmbientTooHot, ExposureWarningCode, ExposureExceptionCode
...
class TestIntegrationExposure0(Sl1FwIntegrationTestCaseBase):
    ...
    def test_print_warning(self):
        ...
        print(warning)
        self.assertEqual(ExposureWarningCode(warning["code"]), ExposureWarningCode.AMBIENT_TOO_HOT)
