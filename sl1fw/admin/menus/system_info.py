...
class SystemInfoMenu(AdminMenu):
    ...
    def __init__(self, control: AdminControl, printer: Printer):
        ...
        self.exposure_resolution = self.add_label()
    ...
    def _run(self):
        ...
        while self._running:
            ...
            self.exposure_resolution.set(f"Exposure resolution: {self._printer.hw.exposure_screen.parameters.width_px}x{self._printer.hw.exposure_screen.parameters.height_px} px")
            ...
            self.slow_tilt.set(f"Slow tilt time: {self._printer.hw.config.tiltSlowTime} s")
            self.fast_tilt.set(f"Fast tilt time: {self._printer.hw.config.tiltFastTime} s")
