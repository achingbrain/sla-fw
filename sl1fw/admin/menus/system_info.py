...
class SystemInfoMenu(AdminMenu):
    ...
    def _run(self):
        ...
        while self._running:
            ...
            self.exposure_resolution.set(f"Exposure resolution: {self._printer.screen.exposure_screen.width_px}x{self._printer.screen.exposure_screen.height_px} px")
            self.printer_model.set(f"Printer model: {self._printer.screen.printer_model.name}")
