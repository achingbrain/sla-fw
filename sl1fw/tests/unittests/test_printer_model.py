...
class TestPrinterModel(Sl1fwTestCase):
    ...
    def test_exposure_screen(self):
        ...
        self.assertEqual(exposure_screen_parameters.size_px, (1024, 768))
        ...
        self.assertEqual(exposure_screen_parameters.width_px, 1024)
        self.assertEqual(exposure_screen_parameters.height_px, 768)
        self.assertEqual(exposure_screen_parameters.detected_size_px, (1024, 768))
