...
class TestPrinterModel(SlafwTestCase):
    ...
    def test_exposure_screen(self):
        ...
        self.assertEqual(exposure_screen_parameters.refresh_delay_ms, 0)
        self.assertEqual(exposure_screen_parameters.monochromatic, False)
        self.assertEqual(exposure_screen_parameters.bgr_pixels, False)
        ...
        self.assertEqual(exposure_screen_parameters.bgr_pixels, True)
