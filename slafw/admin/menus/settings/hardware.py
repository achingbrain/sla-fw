    ...
    def __init__(self, control: AdminControl, printer: Printer):
        ...
        self.add_items(
            (
                ...
                AdminIntValue.from_value("Measuring moves count", self._temp, "measuringMoves", 1, "move_resin_tank_color"),
                AdminIntValue.from_value("Stirring moves count", self._temp, "stirringMoves", 1, "move_resin_tank_color"),
                AdminFloatValue("Delay after stirring [s]", self.get_stirring_delay, self.set_stirring_delay, 0.1, "exposure_times_color"),
